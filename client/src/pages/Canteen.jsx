        ...
        >
          <DialogTitle id="alert-dialog-title">
            ...
            >
              ...
              />{' '} */}
              {editingData ? 'Edit Items' : 'Add Canteen Item'}
            </Typography>
          </DialogTitle>
              ...
              <Grid container spacing={2} justifyContent="center">
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    label="Manufactur Date"
                    variant="outlined"
                    value={data.manufactur_date}
                    onChange={handleInputChange}
                    fullWidth
                    required
                  />
                    ...
                    <TableBody>
                      {submitnewData.map((data, index) => (
                        <TableRow key={index}>
                          ...
                          <TableCell align="center">{data.manufactur_date}</TableCell>
                          ...
                          <TableCell align="center">{data.selling_price}</TableCell>
